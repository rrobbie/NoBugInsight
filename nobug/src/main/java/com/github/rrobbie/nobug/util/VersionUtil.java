package com.github.rrobbie.nobug.util;
...
import com.github.rrobbie.nobug.model.Maintenance;
import com.github.rrobbie.nobug.model.Version;
...
//  ================================================================================================
    ...
    public static int updateHybrid(Context context, Version item, DialogInterface.OnClickListener okListener, DialogInterface.OnClickListener cancelListener) {
        mContext = context;
        version = item;
        ...
        switch (value) {
            case VersionUtil.MAJOR:
            case VersionUtil.MINOR:
                AlertUtil.alertOkCancel(context, null, context.getString(R.string.update_alert_force), null, null, okListener, cancelListener  );
                break;
