package com.github.rrobbie.view.image.picasso;
...
public enum PicassoWithDiskCache {
    ...
    private static final int    MAX_DISK_CACHE_SIZE              = 128 * 1024 * 1024;      // 128MB
